[![Build Status](https://dev.azure.com/swahmad/Pipelines/_apis/build/status/Kinesthetic.ContosoAir?branchName=master)](https://dev.azure.com/swahmad/Pipelines/_build/latest?definitionId=14&branchName=master)
